									...
									<div className={styles.queueActions}>
										{!isUserInQueue ? (
											...
											>
												{actionLoading
													? 'Присоединение...'
													: <div className={styles.connectBtn}>Вступить</div>}
											</button>
										) : (
											<>
